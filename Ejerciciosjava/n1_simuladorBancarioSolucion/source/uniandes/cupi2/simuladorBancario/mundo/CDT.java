...
public class CDT
{
     ...
     * @throws Exception SOLO SE PUEDE TENER UN CDT ACTIVO A LA VEZ
     */
    ...
    public double darInteresMes()
    {
    	return (interesMensual * valorInvertido);
    }
    
    private void verificarInvariante()
    {
    	assert valorInvertido > 0: "El valor invertido no puede ser menor a 0";
    	assert interesMensual > 0: "El interes mensual no puede ser menor a 0";
    	assert mesApertura > 0 : "El mes de apertura no puede ser menor a 0";
    }
}
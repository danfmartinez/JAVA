...
public class SimuladorBancario
{
    ...
    /**
     * monto total consignado del cliente  
     */
    private double montoConsignado;
    ...
    public SimuladorBancario( String pCedula, String pNombre )
    {
        ...
        inversion = new CDT( );
        // Inicializa el monto total consignado
        montoConsignado = 0;
    }
    ...
    {
    	mesActual += pMeses;
    	ahorros.actualizarSaldoPorPasoMeses(pMeses);	
    }
    ...
    {	
    	// Se calcula el interes total generado. 
    	double interesTotal = calcularSaldoTotal() - montoConsignado;
    	// Reinicia el mes en el 1
        mesActual = 1;
        // Reinicia las tres cuentas en vacío
        corriente = new CuentaCorriente( );
        ahorros = new CuentaAhorros( );
        inversion = new CDT( );
    	// Reinicia el monto total consignado por el cliente  
        montoConsignado = 0;
        // retorna los interestotal generado 
        return interesTotal;
    }
}
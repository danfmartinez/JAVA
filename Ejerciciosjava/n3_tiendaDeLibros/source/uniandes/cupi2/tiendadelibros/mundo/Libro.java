...
public class Libro
{
    ...
    // Reto, Coleccion de valores de las transacciones realizadas
    private ArrayList<Double> valorTransacciones;
    ...
    public Libro( String pTitulo, String pIsbn, double pPrecioVenta, double pPrecioCompra, String pRutaImagen )
    {
        ...
        // reto, Inicializa el arraylist
        valorTransacciones = new ArrayList<Double>();
    }
    ...
    public boolean vender( int pCantidad, String pFecha )
    {
        ...
        if( pCantidad <= cantidadActual )
        {
            ...
            vendido = true;
            //reto, Agrega el valor de la venta
            valorTransacciones.add(pCantidad * precioVenta);
        }
        return vendido;
    }
    ...
    public void abastecer( int pCantidad, String pFecha )
    {
        ...
        // Agrega la nueva transacción a la colección de transacciones del libro
        transacciones.add( nueva );
        ///reto, Agrega el valor del abastecimiento 
        valorTransacciones.add(pCantidad * precioCompra);
    }
    ...
    //////reto////
    /**
     * Cambia el precio de venta con uno nuevo
     * @param pNuevoPrecio nuevo precio de venta
     */
    public void cambiarPrecioVenta( double pNuevoPrecio)
    {
    	precioVenta = pNuevoPrecio;
    }
    /**
     * Retorna la coleccion de valores de las trasacciones 
     * @return
     */
    public ArrayList<Double> darValorTransacciones()
    {
